...
end, { desc = "Tree: [T]oggle File Tree Sidebar", remap = true })
vim.keymap.set("n", "tr", function()
	require("nvim-tree.api").tree.reload()
end, { desc = "Tree: [R]eload File System", remap = true })
...
vim.keymap.set("n", "<C-s>g", tele_bin.live_grep, { desc = "[S]earch by [G]rep", remap = true })
